...
To view it, you can click the ![](<../../.gitbook/assets/image (1) (1) (1) (1).png>) three dots after the result, press the ![](<../../.gitbook/assets/image (3).png>) arrow down, and view **Cached**. Another way to manually do this for _any URL_ is by prefixing it with `cache:`, for example:
